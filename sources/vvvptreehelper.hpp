...
void ptree_add_value(boost::property_tree::ptree& tree,
                     PATH_TYPE&& path, DATA_TYPE&& data)
{
    tree.put(path, data);
}

template<typename NAME_TYPE, typename NODE>
void ptree_add_subnode(boost::property_tree::ptree& tree,
                       NAME_TYPE&& name, NODE&& subnode)
{
...
void ptree_array_add_values(boost::property_tree::ptree& arr,
                            DATA&& data, ARGS&&... args)
{
    boost::property_tree::ptree arr_elem1;
    arr_elem1.put("", data);
